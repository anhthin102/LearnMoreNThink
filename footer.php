					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="single-footer br-2 xs-mb">
								...
								<div class="footer-mid-menu" >
									<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.232428814673!2d106.80161941489283!3d10.869918392258176!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317527587e9ad5bf%3A0xafa66f9c8be3c91!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBDw7RuZyBuZ2jhu4cgVGjDtG5nIHRpbiDEkEhRRyBUUC5IQ00!5e0!3m2!1svi!2s!4v1594365216803!5m2!1svi!2s" width="600" height="450" frameborder="0" style="border:0;width: 200px; height: 200px; align-content: center;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="single-footer mrg-sm">
						...
						<div class="footer-contact">
							<p class="adress">
								<span style="color:black;">Công Ty TNHH Learn More N Think</span>
							...
							<p style="color:black;"><i style ="color:black;" class="fa fa-phone-square" aria-hidden="true"></i> Số Điện Thoại: 0996 777 888</p>
							<p style="color:black;"><i style ="color:black;"class="fa fa-envelope" aria-hidden="true"></i> Email: learnmorenthink.com</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row bt-2">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="copy-right-area">
						<p style="color:black;">Copyright ©Learn More And Think. All Right Reserved.</p>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
